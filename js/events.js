...
function updateChooseText(section){
    d3.select("#narrativeChooseSchoolText").html(function(d){
        if(typeof(d) == "undefined") return false
            ...
            return "Among the " + d3.format(".0f")(d.totalSchools) + " " + ALL_LEVELS[d.level].toLowerCase() + "s in " + d.distName + ", " + d.schoolName + " enrolls a " + compareText + " share of Black or Hispanic students than the district."
        }
        else if(section == 5){
