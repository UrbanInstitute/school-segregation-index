...
.attr("transform", "translate(0," + (getVHeight("narrative",1)) + ")")
    ...
    .transition()
    .attr("y", (getVHeight("narrative",1) - margins.bottom + 65))
...
.attr("transform", "translate(0," + (getVHeight("narrative",1)) + ")")
    ...
    d3.select(".xaxis.axis.label.x.main.narrative")
    .transition()
    .attr("y", (getVHeight("narrative",1) - vMargins.bottom + 95))
